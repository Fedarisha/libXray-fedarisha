...
默认情况下，编译脚本不会 clone [Xray-core](https://github.com/XTLS/Xray-core)，而是通过 Go module `replace` 使用 [Fedarisha/Xray-core-fedarisha](https://github.com/Fedarisha/Xray-core-fedarisha)。
