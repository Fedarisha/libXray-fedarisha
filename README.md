...
By default, the build script does not clone [Xray-core](https://github.com/XTLS/Xray-core). It uses Go modules and pins [Fedarisha/Xray-core-fedarisha](https://github.com/Fedarisha/Xray-core-fedarisha) through a Go module `replace`.
